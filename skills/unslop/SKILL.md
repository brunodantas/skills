...
Adapted from the `unslop` skill in [pstack](https://github.com/cursor/plugins/tree/main/pstack)
by Lauren Tan (cursor/plugins, MIT). The body is kept verbatim so upstream diffs stay easy;
only the frontmatter is adapted to this collection's conventions.
